      ...
      <header className="sticky top-0 z-30 border-b border-[var(--color-border)] bg-[var(--color-surface)]/95 backdrop-blur">
        <div className="mx-auto flex min-h-20 max-w-[1600px] items-center justify-between gap-4 px-4 md:px-8">
          ...
          <div className="flex items-center gap-3 text-sm">
            ...
            <button type="button" onClick={() => void logout()} className="min-h-11 rounded-xl border border-[var(--color-border)] px-4 font-semibold outline-none transition-colors hover:bg-[var(--color-bg)] focus-visible:ring-2 focus-visible:ring-[var(--color-accent)] focus-visible:ring-offset-2">إنهاء الجلسة</button>
          </div>
        </div>
